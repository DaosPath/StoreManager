...
public class AppPasswordInput extends VBox {
    ...
    public AppPasswordInput() {
        this(null, null);
    }

    public AppPasswordInput(String labelText) {
        this(labelText, null);
    }

    public AppPasswordInput(String labelText, String promptText) {
    ...
    private void bindFocus(HBox shell, PasswordField field) {
