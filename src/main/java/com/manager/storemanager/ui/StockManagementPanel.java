...
public class StockManagementPanel extends JPanel implements RefreshableView {
    ...
    public StockManagementPanel(User currentUser, StockService stockService) {
    ...
    private void initComponents() {
        ...
        header.add(UIConstants.titleLabel("Gestion de stock"), BorderLayout.WEST);
    ...
    private void loadStock() {
        try {
            currentStock = stockService.findCurrentStock();
    ...
    private void registerEntry() {
        ...
        try {
            stockService.registerStockEntry(product, (Integer) quantitySpinner.getValue(), reasonField.getText(), currentUser);
